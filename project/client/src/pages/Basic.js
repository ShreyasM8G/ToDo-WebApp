...
function viewkey(){
    document.getElementById("View-answers").innerHTML = "A,C,A,B,D";
}
  return (
    <div>
       <ul id="nav1">
    ...
    <div id="myresults" class="my-results">Your results will appear here</div>
    <button class="view-keys" onClick={viewkey}>View answers</button>
    <span id="View-answers" class = "Vans">Answer Keys</span>
    </center>
    </div>
  )
}
